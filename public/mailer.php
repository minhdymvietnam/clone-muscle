...
$site_top = "https://ex-pr.com/recruiting/muscle-saiyou/lp";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
// $to = "saiyou@ex-pr.com,r.uchida@ex-pr.com";
$to = "kido-k@dym.jp";
...
$Referer_check_domain = "ex-pr.com";
...
$refrom_name = "株式会社エグゼクティブプロテクション";
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody.="下記内容で、LPからの応募を受け付けました。\n";
	$adminBody.="内容を確認の上、応募者への連絡をしてください。\n";
	$adminBody.="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
	$adminBody.= postToMail($arr);//POSTデータを関数からセット
	$adminBody.="\n＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n";
	$adminBody.="このメールは応募受信をお知らせする自動通知メールです。\n";
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://ex-pr.com/recruiting/muscle-saiyou/lp" target="_blank">株式会社エグゼクティブプロテクション</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
