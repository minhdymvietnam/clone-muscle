    ...
    <Card className="mx-auto max-w-[1200px] bg-[#00000080] border border-solid border-white backdrop-blur-[10px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(10px)_brightness(100%)] rounded-none">
      <CardContent className="flex flex-col items-center justify-center gap-[50px] py-[35px] px-[50px]">
        <div className="space-y-5 lg:space-y-10 w-full max-w-[546px] mr-[-4.00px]">
          {success ? (
            <>
              <div className="font-bold text-3xl text-center leading-[52.5px] whitespace-nowrap [font-family:'Noto_Sans_JP',Helvetica] text-white tracking-[0]">
                応募が完了しました。
              </div>

              <Separator className="h-[3px] w-[43px] mx-auto bg-[#fcff00]"/>

              <div className="font-medium text-white text-[17px] text-center leading-[29.8px] [font-family:'Noto_Sans_JP',Helvetica] tracking-[0]">
                ご応募ありがとうございます。<br/>
        ...
        <Button 
          onClick={onReset}
          className="w-full justify-start gap-10 max-w-[356px] h-[70px] p-5 rounded-[5px] bg-[linear-gradient(270deg,rgba(252,255,0,1)_0%,rgba(254,255,135,1)_50%,rgba(252,255,0,1)_100%)] hover:bg-[linear-gradient(270deg,rgba(252,255,0,1)_0%,rgba(254,255,135,1)_50%,rgba(252,255,0,1)_100%)]">
          <ChevronLeft className="!size-6 text-white bg-black rounded-full"/>
          <span className="[font-family:'Noto_Sans_JP',Helvetica] font-bold text-black text-[23px] lg:text-3xl text-center tracking-[0] leading-[35px]">
