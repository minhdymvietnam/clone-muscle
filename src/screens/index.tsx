...
export default function LandingPage() {
  ...
  // Wait until full DOM and assets are loaded
  useEffect(() => {
    const onLoadComplete = () => {
      // Ensure render + next paint frame are done
    ...
    if (document.readyState === "complete") {
      ...
      return () => window.removeEventListener("load", onLoadComplete);
    }
  }, []);
  ...
  return (
      <>
        ...
        <div
            id={SectionCode.GOOD_POINT}
            className="bg-black"
            style={{
              backgroundImage: isMobile
                  ? "url(images/good-point-bg-sp.png)"
                  : "url(images/good-point-bg.png)",
              backgroundSize: "cover",
              backgroundPosition: "center",
              backgroundRepeat: "no-repeat",
            }}
